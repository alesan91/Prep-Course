...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let mayorQueDiesYOcho = 0;
  for(let i = 0; i < arreglo.length; i++){
    if( arreglo[i] > 18){
      mayorQueDiesYOcho ++;
    }
  }
  return mayorQueDiesYOcho;
}
...
function breakStatement(numero) {
  ...
  for (let i = 0; i < 10; i++){
    numAument = numAument + 2;
    if (numAument === i){
      interupcion = true;
      break;
    }else{
      valorNum.push(numAument);
